...
def config(client, message):
    ...
    if user.status is "creator" or user.user.id == 1008271006:
        chat_id = message.chat.id
...
__help__ = """
<b>ForceSubscribe:</b>
- Mosia Mk can mute members who are not subscribed your channel until they subscribe
